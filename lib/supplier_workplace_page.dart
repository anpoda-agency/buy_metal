...
const List<String> buyers = <String>['ООО "Инжиниринг"', '*Заказчик 2', '*Заказчик 3', '*Заказчик 4',];
...
class _SupplierWorkplacePageState extends State<SupplierWorkplacePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        child: ListView.builder(itemCount: buyers.length,
        itemBuilder: (BuildContext context, index) {
          return Padding(
            ...
            child: InkWell(onTap: () {Navigator.pushNamed(context, '/selected_buyer_list_of_orders_page');}, 
            child: Padding(
              padding: const EdgeInsets.all(4.0),
              child: Align(alignment: Alignment.centerLeft,child: Text(buyers[index], style: TextStyle(fontSize: 25, color: Colors.white),)),
            ),),
            ),
          ); } ),
      ),     
