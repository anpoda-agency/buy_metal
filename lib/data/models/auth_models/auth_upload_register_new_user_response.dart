...
part 'auth_upload_register_new_user_response.g.dart';

@JsonSerializable()
class AuthUploadRegisterNewUserResponse {
  ...
  const AuthUploadRegisterNewUserResponse({
    this.accessToken = '',
    this.refreshToken = '',
  ...
  AuthUploadRegisterNewUserResponse copyWith({
    ...
    return AuthUploadRegisterNewUserResponse(
