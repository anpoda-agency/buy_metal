...
part 'auth_upload_refresh_token_response.g.dart';

@JsonSerializable()
class AuthUploadRefreshTokenResponse {
  ...
  const AuthUploadRefreshTokenResponse({
    this.accessToken = '',
    this.refreshToken = '',
    this.user = const User(),
  });

  factory AuthUploadRefreshTokenResponse.fromJson(Map<String, dynamic> json) =>
      _$AuthUploadRefreshTokenResponseFromJson(json);
  Map<String, dynamic> toJson() => _$AuthUploadRefreshTokenResponseToJson(this);

  AuthUploadRefreshTokenResponse copyWith({
    String? accessToken,
    String? refreshToken,
    User? user,
  }) {
    return AuthUploadRefreshTokenResponse(
