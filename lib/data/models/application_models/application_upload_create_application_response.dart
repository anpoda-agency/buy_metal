...
part 'application_upload_create_application_response.g.dart';
...
class ApplicationUploadCreateApplicationResponse {
  ...
  const ApplicationUploadCreateApplicationResponse({
    this.amount = 0,
    this.creationDate = '',
  ...
  ApplicationUploadCreateApplicationResponse copyWith({
    ...
    return ApplicationUploadCreateApplicationResponse(
