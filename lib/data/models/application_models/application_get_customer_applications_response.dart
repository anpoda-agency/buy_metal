// application_get_customer_applications_response.dart
// ignore_for_file: public_member_api_docs, sort_constructors_first
import 'package:json_annotation/json_annotation.dart';

import 'package:buy_metal_app/data/models/from_json.dart';

part 'application_get_customer_applications_response.g.dart';
...
class ApplicationGetCustomerApplicationsResponse {
  ...
  const ApplicationGetCustomerApplicationsResponse({
    this.amount = 0,
    this.creationDate = '',
  ...
  ApplicationGetCustomerApplicationsResponse copyWith({
    ...
    return ApplicationGetCustomerApplicationsResponse(
