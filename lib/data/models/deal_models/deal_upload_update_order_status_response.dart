...
part 'deal_upload_update_order_status_response.g.dart';

@JsonSerializable()
class DealUploadUpdateOrderStatusResponse {
  ...
  const DealUploadUpdateOrderStatusResponse({
    this.agreementDate = '',
  ...
  factory DealUploadUpdateOrderStatusResponse.fromJson(Map<String, dynamic> json) =>
      _$DealUploadUpdateOrderStatusResponseFromJson(json);
  Map<String, dynamic> toJson() => _$DealUploadUpdateOrderStatusResponseToJson(this);

  DealUploadUpdateOrderStatusResponse copyWith({
    ...
    return DealUploadUpdateOrderStatusResponse(
