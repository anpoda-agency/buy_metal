...
part 'deal_get_find_deal_by_id_response.g.dart';

@JsonSerializable()
class DealGetFindDealByIdResponse {
  ...
  const DealGetFindDealByIdResponse({
    this.agreementDate = '',
  ...
  factory DealGetFindDealByIdResponse.fromJson(Map<String, dynamic> json) =>
      _$DealGetFindDealByIdResponseFromJson(json);
  Map<String, dynamic> toJson() => _$DealGetFindDealByIdResponseToJson(this);

  DealGetFindDealByIdResponse copyWith({
    ...
    return DealGetFindDealByIdResponse(
