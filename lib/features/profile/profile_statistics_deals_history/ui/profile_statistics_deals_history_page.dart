...
import 'package:buy_metal_app/features/profile/profile_statistics_deals_history/bloc/profile_statistics_deals_history_bloc.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:get_it/get_it.dart';

class ProfileStatisticsDealsHistoryPage extends StatefulWidget {
  const ProfileStatisticsDealsHistoryPage({super.key});

  @override
  State<ProfileStatisticsDealsHistoryPage> createState() => _ProfileStatisticsDealsHistoryPageState();
}

class _ProfileStatisticsDealsHistoryPageState extends State<ProfileStatisticsDealsHistoryPage> {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ProfileStatisticsDealsHistoryBloc(
      ...
      child: BlocConsumer<ProfileStatisticsDealsHistoryBloc, ProfileStatisticsDealsHistoryState>(
              ...
              : listDeals.isNotEmpty
                  ...
                  ? Padding(
                      ...
                      child: RefreshIndicator(
                        onRefresh: () async {
                          context.read<ProfileStatisticsDealsHistoryBloc>().add(ProfileStatisticsDealsHistoryInit());
                        },
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      context
                                          ...
                                          .then((value) => context
                                              .read<ProfileStatisticsDealsHistoryBloc>()
