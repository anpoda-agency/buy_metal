...
class SupplierDealSupplierProposalPage extends StatefulWidget {
  const SupplierDealSupplierProposalPage({
    super.key,
    //required this.args
  });
  //final Object? args;
  ...
  @override
  State<SupplierDealSupplierProposalPage> createState() => _SupplierDealSupplierProposalPageState();
}

class _SupplierDealSupplierProposalPageState extends State<SupplierDealSupplierProposalPage> {
  /* 
 ...
 */
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => SupplierDealSupplierProposalBloc(
          //infoForDeal: args,
      ...
      child:
          BlocConsumer<SupplierDealSupplierProposalBloc, SupplierDealSupplierProposalState>(listener: (context, state) {
